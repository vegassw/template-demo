...
export const seedPetProducts = [
  {
    id: 'pp-001', name: 'Salvaje Adulto Pollo 15kg', slug: 'salvaje-adulto-pollo-15kg', sku: 'ALI-SAL-15', brand: 'Salvaje',
    description: 'Alimento seco para perros adultos con pollo. Fórmula completa y balanceada para todas las razas.',
    price: 39990, salePrice: 29990, stock: 40, categoryId: 'pcat-alimento', featured: true,
    images: ['https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=900&q=85&auto=format'],
    specs: [{ key: 'Marca', value: 'Salvaje' }, { key: 'Peso', value: '15 kg' }, { key: 'Etapa', value: 'Adulto' }, { key: 'Sabor', value: 'Pollo' }],
  },
  {
    id: 'pp-002', name: 'Dogxtreme Adulto Pollo y Arroz 15kg', slug: 'dogxtreme-pollo-arroz-15kg', sku: 'ALI-DGX-15', brand: 'Dogxtreme',
    description: 'Alimento premium para perros activos. Alta palatabilidad con pollo y arroz, refuerza piel y pelaje.',
    price: 44990, salePrice: 35990, stock: 28, categoryId: 'pcat-alimento', featured: true,
    images: ['https://images.unsplash.com/photo-1568640347023-a616a30bc3bd?w=900&q=85&auto=format'],
    specs: [{ key: 'Marca', value: 'Dogxtreme' }, { key: 'Peso', value: '15 kg' }, { key: 'Etapa', value: 'Adulto' }, { key: 'Sabor', value: 'Pollo y arroz' }],
  },
  {
    id: 'pp-003', name: 'Catxtreme Salmón Esterilizado 10kg', slug: 'catxtreme-salmon-esterilizado-10kg', sku: 'ALI-CTX-10', brand: 'Catxtreme',
    description: 'Alimento para gatos esterilizados con salmón. Controla peso y cuida el sistema urinario.',
    price: 34990, salePrice: 27990, stock: 22, categoryId: 'pcat-alimento', featured: false,
    images: ['https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=900&q=85&auto=format'],
    specs: [{ key: 'Marca', value: 'Catxtreme' }, { key: 'Peso', value: '10 kg' }, { key: 'Tipo', value: 'Esterilizado' }, { key: 'Sabor', value: 'Salmón' }],
  },
  {
    id: 'pp-004', name: 'Royal Canin Medium Adult 15kg', slug: 'royal-canin-medium-adult-15kg', sku: 'ALI-RC-15', brand: 'Royal Canin',
    description: 'Nutrición precisa para perros de raza mediana. Salud digestiva y vitalidad comprobada.',
    price: 69990, salePrice: null, stock: 18, categoryId: 'pcat-alimento', featured: true,
    images: ['https://images.unsplash.com/photo-1568640347023-a616a30bc3bd?w=900&q=85&auto=format'],
    specs: [{ key: 'Marca', value: 'Royal Canin' }, { key: 'Peso', value: '15 kg' }, { key: 'Raza', value: 'Mediana' }, { key: 'Etapa', value: 'Adulto' }],
  },
  {
    id: 'pp-005', name: 'Arena Aglomerante Tk-Pet 10kg', slug: 'arena-aglomerante-tkpet-10kg', sku: 'HIG-ARE-10', brand: 'Tk-Pet',
    description: 'Arena sanitaria de alta absorción y rápido aglomerado. Control de olores para gatos.',
    price: 31990, salePrice: 9990, stock: 60, categoryId: 'pcat-higiene', featured: true,
    images: ['https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=900&q=85&auto=format'],
    specs: [{ key: 'Marca', value: 'Tk-Pet' }, { key: 'Peso', value: '10 kg' }, { key: 'Tipo', value: 'Aglomerante' }],
  },
  {
    id: 'pp-006', name: 'Shampoo Hipoalergénico 500ml', slug: 'shampoo-hipoalergenico', sku: 'HIG-SHA-500', brand: 'Nice Care',
    description: 'Shampoo suave con avena y aloe vera para pieles sensibles. pH balanceado, pelaje brillante.',
    price: 12990, salePrice: 9990, stock: 35, categoryId: 'pcat-higiene', featured: false,
    images: ['https://images.unsplash.com/photo-1535930891776-0c2dfb7fda1a?w=900&q=85&auto=format'],
    specs: [{ key: 'Marca', value: 'Nice Care' }, { key: 'Volumen', value: '500 ml' }, { key: 'Fórmula', value: 'Avena + Aloe' }],
  },
  {
    id: 'pp-007', name: 'Pipeta Antipulgas Nexgard', slug: 'pipeta-antipulgas-nexgard', sku: 'HIG-NEX-01', brand: 'Nexgard',
    description: 'Protección antiparasitaria externa contra pulgas y garrapatas. Acción rápida y duradera.',
    price: 16990, salePrice: 10990, stock: 50, categoryId: 'pcat-higiene', featured: false,
    images: ['https://images.unsplash.com/photo-1576201836106-db1758fd1c97?w=900&q=85&auto=format'],
    specs: [{ key: 'Marca', value: 'Nexgard' }, { key: 'Uso', value: 'Externo' }, { key: 'Duración', value: '30 días' }],
  },
  {
    id: 'pp-008', name: 'Pelota Interactiva Tootoy', slug: 'pelota-interactiva-tootoy', sku: 'JUG-TOO-01', brand: 'Tootoy',
    ...
    images: ['https://images.unsplash.com/photo-1576201836106-db1758fd1c97?w=900&q=85&auto=format'],
    specs: [{ key: 'Marca', value: 'Tootoy' }, { key: 'Material', value: 'Caucho natural' }, { key: 'Tamaño', value: 'Mediano' }],
  },
  {
    id: 'pp-009', name: 'Cuerda Mordedora Nylabone', slug: 'cuerda-mordedora-nylabone', sku: 'JUG-NYL-01', brand: 'Nylabone',
    ...
    specs: [{ key: 'Marca', value: 'Nylabone' }, { key: 'Material', value: 'Algodón' }, { key: 'Largo', value: '30 cm' }],
  },
  {
    id: 'pp-010', name: 'Collar Ajustable Mpets', slug: 'collar-ajustable-mpets', sku: 'ACC-MPE-01', brand: 'Mpets',
    ...
    specs: [{ key: 'Marca', value: 'Mpets' }, { key: 'Material', value: 'Nylon' }, { key: 'Tallas', value: 'S / M / L' }],
  },
  {
    id: 'pp-011', name: 'Cama Ortopédica Leeby', slug: 'cama-ortopedica-leeby', sku: 'ACC-LEE-01', brand: 'Leeby',
    ...
    specs: [{ key: 'Marca', value: 'Leeby' }, { key: 'Tamaño', value: '70x55 cm' }, { key: 'Funda', value: 'Lavable' }],
  },
];
